...
class AthleteAthleteSearchPage extends StatefulWidget {
  const AthleteAthleteSearchPage({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _AthleteAthleteSearchPageState createState() => _AthleteAthleteSearchPageState();
}

class _AthleteAthleteSearchPageState extends State<AthleteAthleteSearchPage> {
