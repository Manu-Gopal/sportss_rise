...
// class AthleteEditProfile1 extends StatefulWidget {
//   const AthleteEditProfile1({Key? key}) : super(key: key);

//   @override
//   // ignore: library_private_types_in_public_api
//   _AthleteEditProfile1State createState() => _AthleteEditProfile1State();
// }

// class _AthleteEditProfile1State extends State<AthleteEditProfile1> {
...
//     userData = Supabase.instance.client
//           .from('profile')
...
//                               final response = await supabase.from('profile').update([userDetails] as Map).eq('user_id', userId);
