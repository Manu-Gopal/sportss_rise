...
class AthleteNews extends StatefulWidget {
  const AthleteNews({super.key});

  @override
  State<AthleteNews> createState() => _AthleteNewsState();
}

class _AthleteNewsState extends State<AthleteNews> {
